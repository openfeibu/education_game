                ...
                <form class="layui-form" action="{{guard_url('user/'.$user->id)}}" method="post" lay-filter="fb-form">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="email" value="{{ $user->name }}" lay-verify="title" autocomplete="off" placeholder="{{ trans('user.please_input') }}{{ trans("user.label.name") }}" class="layui-input" disabled>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="password" name="password" placeholder="{{ trans('user.please_input') }}{{ trans("user.label.password") }}，不改则留空" autocomplete="off" class="layui-input">
                        </div>
