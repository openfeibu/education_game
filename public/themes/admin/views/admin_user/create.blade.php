                ...
                <form class="layui-form" action="{{guard_url('admin_user')}}" method="post" lay-filter="fb-form">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="email" value="{{ $admin_user->email }}" lay-verify="title" autocomplete="off" placeholder="{{ trans('user.please_input') }}{{ trans("admin_user.label.email") }}" class="layui-input" >
                        </div>
                    </div>
