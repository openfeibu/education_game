...
<section id="main">
    ...
    <div id="g3-park1">
        <div class="tips">
            <div class="tips-item">
                <p class="gcenterIn" style="width: 34.6%"><img src="<?php echo theme_asset_lang("images/g3-1.png"); ?>" alt=""></p>
                <br/>
                <div class="btn c1-btn delay-1 gdownIn" style="width: 19.2%"><img src="<?php echo theme_asset_lang("images/g2-2.png"); ?>" alt=""></div>
            </div>
        </div>
    </div>
    <div id="g3-park2">
        <div id="video_box" >
            <video id="c1" class="video video-position" style="object-fit:fill;"  width="100%" htyle="object-fit:fill;"  width="100%" height="100%"  preload="auto" playsinline="true" webkit-playsinline="true" x-webkit-airplay="allow" airplay="allow"  x5-video-orientation="portrait" x5-video-player-type="h5" x5-video-player-fullscreen="true" src="<?php echo theme_asset_lang("video/c1.mp4"); ?>"></video>
        </div>
    </div>
    <div id="g3-park3">
        <div class="question" >
            <div class="question-bg" style="width: 68.1%;left: 16%;top: 10%">
                <img src="<?php echo theme_asset_lang("images/g3-2.png"); ?>" width="100%" alt="">
                <div class="question-list">
                    <div class="question-item fb-transition grightIn" tid = "A">
                        <img src="<?php echo theme_asset_lang("images/g3-3.png"); ?>" width="100%" alt="">
                    </div>
                    <div class="question-item fb-transition grightIn"  tid = "B">
                        <img src="<?php echo theme_asset_lang("images/g3-4.png"); ?>" width="100%" alt="">
                    </div>
                    <div class="question-item fb-transition grightIn"  tid = "C">
                        <img src="<?php echo theme_asset_lang("images/g3-5.png"); ?>" width="100%" alt="">
                    </div>
                    <div class="question-item fb-transition grightIn"  tid = "D">
                        <img src="<?php echo theme_asset_lang("images/g3-6.png"); ?>" width="100%" alt="">
                    </div>
                    <div class="question-item fb-transition grightIn"  tid = "E">
                        <img src="<?php echo theme_asset_lang("images/g3-7.png"); ?>" width="100%" alt="">
                    </div>
                </div>
    ...
    <div id="g3-park9">
        <div class="tips">
            <div class="tips-item">
                <p class="gcenterIn delay-1" style="width:65.6%"><img src="<?php echo theme_asset_lang("images/g3-8.png"); ?>" alt=""></p>
    ...
    <div id="g3-park10">
        <div class="tips">
            <div class="tips-item">
                <div class="game-result gcenterIn " style="width: 26.2%" ><img src="<?php echo theme_asset_lang("images/g3-result.png"); ?>" width="100%" alt=""></div>
                <br>
